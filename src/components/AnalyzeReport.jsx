...
export default function AnalyzeReport({ onNotification }) {
  ...
  const [analysisResult, setAnalysisResult] = useState({
    ...
    reasons: 'Analysis detected a failure in verification protocols for energy isolation, a high-frequency SIF precursor.',
    whyFlagged: 'Analysis detected a failure in verification protocols for energy isolation, a high-frequency SIF precursor.',
    pattern_status: 'ESCALATED',
    patternStatus: 'ESCALATED',
    pattern_message: 'Potential SIF risk increased due to recurring related observations.',
    patternMessage: 'Potential SIF risk increased due to recurring related observations.',
    escalation_triggered: true,
    escalationTriggered: true,
    pattern_tags: ['Same location', 'Same hazard', 'Repeated related observations', 'Increasing risk trajectory'],
    patternTags: ['Same location', 'Same hazard', 'Repeated related observations', 'Increasing risk trajectory'],
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res) {
        ...
        if (onNotification) {
          onNotification(`FastAPI Response: Risk ${res.riskScore || res.risk_score}/100 • SIF: ${res.potentialSif || res.potential_sif}`);
        }
      }
    } catch (err) {
  ...
  return (
    <div className="flex-grow flex flex-col p-container-padding gap-5 max-w-[1920px] mx-auto w-full">
      ...
      <header className="flex flex-col gap-0.5">
        ...
        <p className="font-body-md text-sm text-secondary">Evaluate a safety observation or near-miss for potential SIF precursors.</p>
      </header>
        ...
        <div className="lg:col-span-5 bg-surface-container-lowest border border-outline-variant p-6 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-2 text-xs text-secondary font-medium">
              ...
              <span>Individual SIF Analysis</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="border border-outline-variant p-3 text-center flex flex-col justify-center items-center bg-surface-container-lowest">
                <span className="font-label-md text-[10px] text-secondary uppercase block mb-1">RISK SCORE</span>
              ...
              <div className="border border-outline-variant p-3 text-center flex flex-col justify-center items-center bg-surface-container-lowest">
                <span className="font-label-md text-[10px] text-secondary uppercase block mb-1">RISK LEVEL & PRIORITY</span>
          ...
          <div className="flex flex-col gap-3 pt-3 border-t border-outline-variant">
            ...
            <p className="text-xs text-secondary">Report cross-referenced with database history.</p>
